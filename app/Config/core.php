 ...
 */
	Configure::write('Security.salt', 'LHFGIKgsadHlk8hGGHJDFGHhgjsdhgfs2guVoUubWwvni145fIUJUFSaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '5645649478647483222872453697489796');
